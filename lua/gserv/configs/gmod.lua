return {
    ...
    addons = {
        ["https://github.com/wiremod/wire-extras"] = {
            type = "git",
            url = "https://github.com/wiremod/wire-extras.git",
            key = "https://github.com/wiremod/wire-extras",
            name = "wire-extras",
        },
        ["https://github.com/PAC3-Server/ServerAssets.git"] = {
            type = "git",
            name = "serverassets",
            key = "https://github.com/PAC3-Server/ServerAssets.git",
            url = "https://github.com/PAC3-Server/ServerAssets.git",
        },
        ["https://github.com/PAC3-Server/FProfiler"] = {
            type = "git",
            url = "https://github.com/PAC3-Server/FProfiler.git",
            name = "fprofiler",
            key = "https://github.com/PAC3-Server/FProfiler",
        },
        ["https://github.com/CapsAdmin/pac3.git"] = {
            branch = "develop",
            url = "https://github.com/CapsAdmin/pac3.git",
            type = "git",
            key = "https://github.com/CapsAdmin/pac3.git",
            name = "pac3",
        },
        ["https://github.com/PAC3-Server/garrysmod"] = {
            type = "git",
            key = "https://github.com/PAC3-Server/garrysmod",
            name = "garrysmod",
            url = "https://github.com/PAC3-Server/garrysmod.git",
        },
        ["https://github.com/PAC3-Server/VJ-Base.git"] = {
            type = "git",
            url = "https://github.com/PAC3-Server/VJ-Base.git",
            name = "vj-base",
            key = "https://github.com/PAC3-Server/VJ-Base.git",
        },
        ["580180254"] = {
            id = "580180254",
            type = "workshop",
            url = "580180254",
            key = "580180254",
            name = "CS 2.6 SWEP PACK_580180253",
        },
        ["108720351"] = {
            id = "108720351",
            type = "workshop",
            url = "108720351",
            key = "108720351",
            name = "CSS Weapons on M10K Base_108720350",
        },
        ["https://github.com/PAC3-Server/FProfiler.git"] = {
            type = "git",
            url = "https://github.com/PAC3-Server/FProfiler.git",
            name = "fprofiler",
            key = "https://github.com/PAC3-Server/FProfiler.git",
        },
        ["https://github.com/PAC3-Server/workshop-addons.git"] = {
            type = "git",
            url = "https://github.com/PAC3-Server/workshop-addons.git",
            key = "https://github.com/PAC3-Server/workshop-addons.git",
            name = "workshop-addons",
        },
        ["https://github.com/PAC3-Server/gm-mediaplayer.git"] = {
            type = "git",
            name = "gm-mediaplayer",
            key = "https://github.com/PAC3-Server/gm-mediaplayer.git",
            url = "https://github.com/PAC3-Server/gm-mediaplayer.git",
        },
        ["https://github.com/PAC3-Server/Sit-Anywhere.git"] = {
            type = "git",
            url = "https://github.com/PAC3-Server/Sit-Anywhere.git",
            name = "sit-anywhere",
            key = "https://github.com/PAC3-Server/Sit-Anywhere.git",
        },
        ["https://github.com/PAC3-Server/notagain.git"] = {
            type = "git",
            url = "https://github.com/PAC3-Server/notagain.git",
            key = "https://github.com/PAC3-Server/notagain.git",
            name = "notagain",
        },
        ["https://github.com/PAC3-Server/EPOE.git"] = {
            type = "git",
            url = "https://github.com/PAC3-Server/EPOE.git",
            name = "epoe",
            key = "https://github.com/PAC3-Server/EPOE.git",
        },
        ["https://github.com/PAC3-Server/wire.git"] = {
            type = "git",
            url = "https://github.com/PAC3-Server/wire.git",
            name = "wire",
            key = "https://github.com/PAC3-Server/wire.git",
        },
        ["https://steamcommunity.com/sharedfiles/filedetails/?id=173482197"] = {
            id = "173482197",
            type = "workshop",
            url = "https://steamcommunity.com/sharedfiles/filedetails/?id=173482197",
            key = "https://steamcommunity.com/sharedfiles/filedetails/?id=173482197",
            name = "sprops_workshop_edition_173482197",
        },
        ["https://github.com/PAC3-Server/advdupe2.git"] = {
            type = "git",
            url = "https://github.com/PAC3-Server/advdupe2.git",
            name = "advdupe3",
            key = "https://github.com/PAC3-Server/advdupe2.git",
        },
        ["https://github.com/PAC3-Server/gm-http-discordrelay.git"] = {
            type = "git",
            name = "gm-http-discordrelay",
            key = "https://github.com/PAC3-Server/gm-http-discordrelay.git",
            url = "https://github.com/PAC3-Server/gm-http-discordrelay.git",
        },
        ["http://steamcommunity.com/sharedfiles/filedetails/?id=741857903&searchtext=Playable+Piano"] = {
            id = "741857903",
            type = "workshop",
            url = "http://steamcommunity.com/sharedfiles/filedetails/?id=741857903&searchtext=Playable+Piano",
            key = "http://steamcommunity.com/sharedfiles/filedetails/?id=741857903&searchtext=Playable+Piano",
            name = "playable_piano_fork_741857903",
        },
    },
    screenshots = {
